...
import type { GetItemsOptions, CreateClipboardEntryDto, UpdateClipboardEntryDto, ClipboardEntry } from "$lib/types";
...
class ClipboardStore {
  ...
  // Create item
  async createItem(data: CreateClipboardEntryDto) {
    try {
  ...
  // Update item
  async updateItem(id: string, data: UpdateClipboardEntryDto) {
    try {
